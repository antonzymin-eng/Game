...
namespace game::military {
    ...
    enum class UnitType {
        // Infantry
        LEVIES = 0, SPEARMEN, SWORDSMEN, CROSSBOWMEN, LONGBOWMEN, MEN_AT_ARMS, PIKEMEN, ARQUEBUSIERS, MUSKETEERS,
        // Cavalry  
        LIGHT_CAVALRY, HEAVY_CAVALRY, MOUNTED_ARCHERS, DRAGOONS,
        // Siege Equipment
        CATAPULTS, TREBUCHETS, CANNONS, SIEGE_TOWERS,
        // Naval Units
        GALLEYS, COGS, CARRACKS, GALLEONS, WAR_GALLEONS, SHIPS_OF_THE_LINE,
        COUNT
    };
